...
Welcome to the **App Store Connect CLI** (`asc`) - a community-maintained command-line tool for automating iOS, macOS, tvOS, and visionOS release workflows.
...
* **Automation-friendly**: Stable JSON output and explicit flags for scripts and CI
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/installation">
    Build asc from an exact reviewed source commit
  </Card>
