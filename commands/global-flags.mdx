...
Use a named authentication profile stored in the private config file.
...
Fail when credentials are complete in both the selected file profile and environment variables.
