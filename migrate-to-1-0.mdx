...
* Removed `asc apps create` -> create the app record in App Store Connect
...
Apple does not expose app-record creation through the public API. Create the
record in App Store Connect, then use the API-key-driven `apps` family.
