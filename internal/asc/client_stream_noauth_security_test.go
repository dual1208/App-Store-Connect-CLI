...
func TestDoStreamNoAuthRejectsInsecureAndUserinfoURLs(t *testing.T) {
	client := &Client{httpClient: &http.Client{}}
	for _, rawURL := range []string{
		"http://apple.com/file",
		"https://user:secret@apple.com/file",
	} {
		if _, err := client.doStreamNoAuth(context.Background(), rawURL, "application/octet-stream"); err == nil {
