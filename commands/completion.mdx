...
metadata      profiles      submit        testflight
users         webhooks      workflow      xcode-cloud
```
...
```bash  theme={null}
# Add a user completion directory
mkdir -p ~/.local/share/zsh/site-functions
asc completion --shell zsh > ~/.local/share/zsh/site-functions/_asc
...
# macOS: install a completion package with your system package manager
```
