...
<div className="relative overflow-x-hidden dark:bg-[#0f1117] bg-[#FAFAFA]">
  ...
  <div className="mt-16 mb-16 max-w-5xl mx-auto px-6">
    ...
    <Steps>
      <Step title="Install the CLI">
        Build an exact reviewed commit:
      ...
      <Step title="Authenticate with your API key">
        ...
        <Note>
          Your credentials use private config files or explicit environment variables.
        </Note>
      </Step>
  ...
  <div className="mt-16 mb-16 max-w-5xl mx-auto px-6">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Automation" icon="code-branch" href="/guides/automation">
