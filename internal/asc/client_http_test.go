...
func TestDownloadCiArtifact_UserinfoRejected(t *testing.T) {
	client := newTestClient(t, nil, nil)
	if _, err := client.DownloadCiArtifact(context.Background(), "https://user:secret@appstoreconnect.apple.com/artifact.zip"); err == nil {
