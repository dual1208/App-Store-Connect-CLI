...
func TestDocsListOutputsEmbeddedGuidesAsJSON(t *testing.T) {
	...
	expectedSlugs := []string{"api-notes", "workflows"}
...
func TestDocsListSupportsMarkdownOutput(t *testing.T) {
	...
	for _, slug := range []string{"api-notes", "workflows"} {
...
func TestDocsListSupportsTableOutput(t *testing.T) {
	...
	if !strings.Contains(stdout, "api-notes") || !strings.Contains(stdout, "workflows") {
...
func TestDocsShowUnknownGuideReturnsUsageError(t *testing.T) {
	...
	if !strings.Contains(stderr, "api-notes") || !strings.Contains(stderr, "workflows") {
