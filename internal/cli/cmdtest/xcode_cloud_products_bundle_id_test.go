...
func TestXcodeCloudProductsTableIncludesRelatedAppBundleID(t *testing.T) {
	...
	http.DefaultTransport = roundTripFunc(func(req *http.Request) (*http.Response, error) {
		...
		case 2:
			...
			body := `{"data":{"type":"apps","id":"app-1","attributes":{"name":"FoundationLab","bundleId":"com.example.foundationlab","sku":"FoundationLab123","primaryLocale":"en-US"}}}`
			return &http.Response{
				StatusCode: http.StatusOK,
				Body:       io.NopCloser(strings.NewReader(body)),
				Header:     http.Header{"Content-Type": []string{"application/json"}},
	...
	if !strings.Contains(stdout, "com.example.foundationlab") {
