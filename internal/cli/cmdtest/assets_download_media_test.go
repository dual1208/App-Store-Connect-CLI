...
func TestScreenshotsDownload_ByID_WritesFile(t *testing.T) {
	...
	http.DefaultTransport = roundTripFunc(func(req *http.Request) (*http.Response, error) {
		...
		case "api.appstoreconnect.apple.com":
			...
			body := `{"data":{"type":"appScreenshots","id":"shot-1","attributes":{"fileName":"shot.png","fileSize":7,"imageAsset":{"templateUrl":"https://is1-ssl.mzstatic.com/assets/{w}x{h}bb.{f}","width":1242,"height":2688}}}}`
		...
		case "is1-ssl.mzstatic.com":
			...
			if got := strings.TrimSpace(req.Header.Get("User-Agent")); got != "asc/asset-download" {
	...
	http.DefaultTransport = roundTripFunc(func(req *http.Request) (*http.Response, error) {
		...
		case "api.appstoreconnect.apple.com":
			...
			case "/v1/appScreenshotSets/set-1/appScreenshots":
				body := `{"data":[{"type":"appScreenshots","id":"shot-b","attributes":{"fileName":"01-home.png","fileSize":7,"imageAsset":{"templateUrl":"https://is1-ssl.mzstatic.com/shot-b_{w}x{h}.{f}","width":100,"height":200}}},{"type":"appScreenshots","id":"shot-a","attributes":{"fileName":"02-paywall.png","fileSize":7,"imageAsset":{"templateUrl":"https://is1-ssl.mzstatic.com/shot-a_{w}x{h}.{f}","width":100,"height":200}}}]}`
				return &http.Response{
					StatusCode: http.StatusOK,
					Body:       io.NopCloser(strings.NewReader(body)),
					Header:     http.Header{"Content-Type": []string{"application/json"}},
...
func TestScreenshotsDownload_ByLocalization_RetriesTransientForbidden(t *testing.T) {
	...
	http.DefaultTransport = roundTripFunc(func(req *http.Request) (*http.Response, error) {
		...
		case "api.appstoreconnect.apple.com":
			...
			case "/v1/appScreenshotSets/set-1/appScreenshots":
				body := `{"data":[{"type":"appScreenshots","id":"shot-1","attributes":{"fileName":"screen.png","fileSize":7,"imageAsset":{"templateUrl":"https://is1-ssl.mzstatic.com/screen_{w}x{h}.{f}","width":100,"height":200}}}]}`
				return &http.Response{
					StatusCode: http.StatusOK,
					Body:       io.NopCloser(strings.NewReader(body)),
					Header:     http.Header{"Content-Type": []string{"application/json"}},
...
func TestVideoPreviewsDownload_ByID_WritesFile(t *testing.T) {
	...
	http.DefaultTransport = roundTripFunc(func(req *http.Request) (*http.Response, error) {
		...
		case "api.appstoreconnect.apple.com":
			...
			body := `{"data":{"type":"appPreviews","id":"prev-1","attributes":{"fileName":"preview.mov","fileSize":7,"mimeType":"video/quicktime","videoUrl":"https://is1-ssl.mzstatic.com/preview.mov"}}}`
			return &http.Response{
				StatusCode: http.StatusOK,
				Body:       io.NopCloser(strings.NewReader(body)),
				Header:     http.Header{"Content-Type": []string{"application/json"}},
	...
	http.DefaultTransport = roundTripFunc(func(req *http.Request) (*http.Response, error) {
		...
		case "api.appstoreconnect.apple.com":
			...
			case "/v1/appPreviewSets/set-1/appPreviews":
				body := `{"data":[{"type":"appPreviews","id":"prev-1","attributes":{"fileName":"p.mov","fileSize":7,"mimeType":"video/quicktime","videoUrl":"https://is1-ssl.mzstatic.com/p.mov"}}]}`
				return &http.Response{
					StatusCode: http.StatusOK,
					Body:       io.NopCloser(strings.NewReader(body)),
					Header:     http.Header{"Content-Type": []string{"application/json"}},
