...
var rootUsageGroups = []rootCommandGroup{
	...
	},
	{
		...
		commands: []string{"signing", "bundle-ids", "certificates", "profiles", "merchant-ids", "pass-type-ids"},
	},
	{
	...
	},
	{
		...
		commands: []string{"workflow", "webhooks", "xcode-cloud"},
	},
	{
		title:    "UTILITY COMMANDS",
		commands: []string{"diff", "capabilities", "search", "version", "completion", "schema"},
	},
}
