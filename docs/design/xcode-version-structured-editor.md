...
xcconfig inheritance. An additional project model could provide more coverage, but
would create a new parser maintenance burden. Calling an external scripting
runtime violates the single-binary/no-runtime-dependency contract. The
