...
<Accordion title="What is the App Store Connect CLI?">
  The App Store Connect CLI (`asc`) is a fast, lightweight, and scriptable command-line tool for the App Store Connect API. It allows you to automate iOS, macOS, tvOS, and visionOS release workflows from your terminal, IDE, or CI/CD pipeline.
...
<Accordion title="How do I authenticate with App Store Connect?">
  ...
  Credentials are stored in `~/.asc/config.json` with restricted permissions; private key material remains in the referenced `.p8` file.
</Accordion>
...
<Accordion title="Can I use environment variables for authentication?">
  ...
  Priority order: selected config-file profile, default config-file profile, then complete environment credentials.
</Accordion>
...
<Accordion title="Can I use this in CI/CD pipelines?">
  ...
  See the [CI/CD guide](https://github.com/dual1208/App-Store-Connect-CLI/blob/main/docs/CI_CD.md) for detailed examples.
</Accordion>
...
<Accordion title="Where can I find API documentation?">
  Use Apple's App Store Connect API documentation:
...
<Accordion title="How do I report security issues?">
  ...
  [https://github.com/dual1208/App-Store-Connect-CLI/security/advisories/new](https://github.com/dual1208/App-Store-Connect-CLI/security/advisories/new)
...
<Accordion title="Can I use this on Linux?">
  ...
  * Authentication and web-session persistence use private files
  ...
  * All core functionality works identically
  ...
  Build the reviewed source commit using the Go version declared by `go.mod`:
...
<Accordion title="How do I update to the latest version?">
  Review and check out the exact source commit you want, then rebuild:
  ...
  View releases: [https://github.com/dual1208/App-Store-Connect-CLI/releases](https://github.com/dual1208/App-Store-Connect-CLI/releases)
</Accordion>
...
<Accordion title="Where can I get help?">
  ...
  For issues: [https://github.com/dual1208/App-Store-Connect-CLI/issues](https://github.com/dual1208/App-Store-Connect-CLI/issues)
</Accordion>
