...
Apple does not expose app-record creation through the public App Store Connect
API. Create the app record in App Store Connect, then use `asc apps` for the
