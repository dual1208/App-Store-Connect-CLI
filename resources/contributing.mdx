...
* (Optional) macOS for platform-specific build testing
...
**Important**: Use the compatibility environment switch and isolated file paths when running tests:
...
Credentials are stored in `~/.asc/config.json`, or `./.asc/config.json` for a repo-local profile.
...
[https://github.com/dual1208](https://github.com/dual1208)
...
* API docs: [Apple App Store Connect API documentation](https://developer.apple.com/documentation/appstoreconnectapi/)

## Getting Help

If you need help:

1. **Check existing issues**: [https://github.com/dual1208/App-Store-Connect-CLI/issues](https://github.com/dual1208/App-Store-Connect-CLI/issues)
...
Please review and follow the [Code of Conduct](https://github.com/dual1208/App-Store-Connect-CLI/blob/main/CODE_OF_CONDUCT.md).
