...
case $EXIT_CODE in
  0)
    ...
    ;;
  4)
    echo "App not found. Create it in App Store Connect before retrying."
		exit 1
    ;;
  3)
...
* [Exit Codes Reference](https://github.com/dual1208/App-Store-Connect-CLI/blob/main/cmd/exit_codes.go) - Source code
