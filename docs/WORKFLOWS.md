...
that previously came from external release scripts.
...
- Add `"ASC_BYPASS_KEYCHAIN": "1"` to the top-level `env` block as a legacy
  compatibility safeguard, and set temporary credential/session file paths.
